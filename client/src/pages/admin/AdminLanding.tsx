      ...
      <div className="rounded-xl border border-slate-700 bg-slate-900/80 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-slate-700 bg-slate-800/60">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-slate-100">Manager Orientation</span>
        ...
        <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
          <iframe
            src="https://www.youtube.com/embed/vKmuFFcLW-c"
            title="Manager Orientation — VNC ICU Portal Decision Workflow"
        ...
        <div className="px-5 py-3 border-t border-slate-700/60 bg-slate-800/30 flex items-center justify-between">
          <p className="text-xs text-slate-500">Full decision framework, governance process, and holiday submission guide.</p>
          <a
            href="/manager-guide.html"
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-semibold text-cyan-400 hover:text-cyan-300 underline underline-offset-2 transition-colors shrink-0 ml-4"
          >
            Learn more →
          </a>
        </div>
