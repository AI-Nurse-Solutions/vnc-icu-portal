        ...
        <div className="bg-card border border-border/60 rounded-2xl shadow-2xl p-8">
          {done ? (
            ...
            <div className="text-center py-4">
              ...
              <a href="/forgot-password" className="text-primary text-sm hover:underline mt-2 block">Request new link</a>
            </div>
          ) : (
            <>
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-foreground">Create a new password</h2>
